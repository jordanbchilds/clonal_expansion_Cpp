...
int main(){
	...
	std::filesystem::current_path("/Users/jordanchilds/Documents/GitHub/clonal_expansion_Cpp/time_gillespie/CPU");
	ofstream file ("./noControl_simTimes.txt");
